    ...
    <Container className="py-14">
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <a
          ...
          className="group rounded-2xl border border-line bg-card p-6 transition-colors duration-150 hover:border-line"
        >
          ...
          <p className="mt-3 font-semibold text-ink tnum">{contact.phone}</p>
        </a>
        ) : null}
        ...
        >
          ...
          <p className="mt-3 font-semibold text-ink">Message us</p>
        </a>
        ) : null}
        ...
        >
          ...
          <p className="mt-3 break-all font-semibold text-ink">{contact.email}</p>
        </a>
        ) : null}
      </div>
