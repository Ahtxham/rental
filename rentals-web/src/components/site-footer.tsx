    ...
    <footer className="mt-24 bg-forest text-paper">
      <Container className="grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-5">
        <div className="lg:col-span-2">
          ...
          <p className="mt-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-brass-bright">
            Rent A Car
          </p>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5 text-sm text-paper/80">
            {PAGES.map((link) => (
              <li key={link.href}>
                <Link
                  href={link.href}
                  className="transition-colors duration-150 hover:text-brass-bright"
                >
                  {link.label}
                </Link>
              </li>
          ...
          <h2 className="mt-7 text-[11px] font-semibold uppercase tracking-[0.18em] text-brass-bright">
            Musafir
          </h2>
          <ul className="mt-4 space-y-2.5 text-sm text-paper/80">
            {COMPANY.map((link) => (
